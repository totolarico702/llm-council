...
export const ROUTES = {
  ...
  pipelines: {
    ...
    score:        (id) => `${BASE}/pipelines/${id}/score`,
  ...
  admin: {
    ...
    userSoftArchive:  (id) => `${BASE}/admin/users/${id}/soft-archive`,
    userReactivate:   (id) => `${BASE}/admin/users/${id}/reactivate`,
  ...
  agents: {
    list:        `${BASE}/agents`,
    create:      `${BASE}/agents`,
    get:         (id) => `${BASE}/agents/${id}`,
    update:      (id) => `${BASE}/agents/${id}`,
    delete:      (id) => `${BASE}/agents/${id}`,
    trigger:     (id) => `${BASE}/agents/${id}/trigger`,
    pause:       (id) => `${BASE}/agents/${id}/pause`,
    resume:      (id) => `${BASE}/agents/${id}/resume`,
    executions:  (id) => `${BASE}/agents/${id}/executions`,
  },

  // ── Catalogue agents métier ─────────────────────────────
  catalog: {
    agents:   `${BASE}/catalog/agents`,
    domains:  `${BASE}/catalog/agents/domains`,
    byDomain: (d) => `${BASE}/catalog/agents?domain=${encodeURIComponent(d)}`,
  },

  // ── Model Advisor ────────────────────────────────────────
  advisor: {
    recommendNode: `${BASE}/advisor/recommend-node`,
    capabilities:  `${BASE}/advisor/model-capabilities`,
    taskTypes:     `${BASE}/advisor/task-types`,
  },

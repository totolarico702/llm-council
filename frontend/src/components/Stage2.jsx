...
export default function Stage2({ rankings, labelToModel, aggregateRankings }) {
  ...
  const safeAggregate = Array.isArray(aggregateRankings) ? aggregateRankings : [];

  if (safeRankings.length === 0) {
    return null;
  }

  const current = safeRankings[activeTab] || safeRankings[0];
  ...
  return (
    <div className="stage stage2">
      ...
      <div className="tab-content">
        ...
        {Array.isArray(current.parsed_ranking) &&
